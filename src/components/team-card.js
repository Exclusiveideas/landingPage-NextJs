  ...
  return (
    <Box sx={styles.card}>
      ...
      <Box sx={styles.infoWrapper}>
        <Heading className="info__name" sx={styles.infoWrapper.name}>{title}</Heading>
        <Text className="info__designation" s={styles.infoWrapper.designation}>{designation}</Text>
      </Box>
